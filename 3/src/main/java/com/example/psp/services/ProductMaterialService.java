...
public class ProductMaterialService {
    ...
    public List<ProductMaterial> productMaterialProductIdGet(Integer productId, User user)  {return null;}

    public void productMaterialProductIdMaterialIdDelete(Integer productId, Integer materialId, User user)  {}

    public ProductMaterial productMaterialProductIdMaterialIdGet(Integer productId, Integer materialId, User user)  {return null;}
