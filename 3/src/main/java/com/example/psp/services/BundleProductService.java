...
public class BundleProductService {
    ...
    public BundleProduct bundleProductBundleIdProductIdGet(Integer bundleId, Integer productId, User user) {
        return null;
    }
    ...
    public List<BundleProduct> bundleProductBundleIdGet(Integer bundleId, User user) {
        return null;
    }
}
